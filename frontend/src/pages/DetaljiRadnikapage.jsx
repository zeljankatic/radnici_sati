...
function DetaljiRadnikapage() {
  ...
  const formik = useFormik ({
    ...
    onSubmit: (values) => {
      console.log(values)
      RadniSatiService.prenosBazaSati(values)
  ...
  return (
    <div className=''>
      <h1 className='uppercase text-center mt-[40px]'>Unos podataka za radnika
        <span className='border mx-[20px] bg-blue-300 px-[16px] rounded-lg'>{radnik.ime} {radnik.prezime}</span>
      </h1>
